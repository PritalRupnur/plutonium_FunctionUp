...
const coustmerController = require("../controllers/coustmerController")
...
router.post("/createCoustmer", coustmerController.headerValidationCoust, coustmerController.createCoustmer)
